...
const KNOWN_EMPLOYEES = new Set([
  "Z0039","Z0037","Z0050","Z0068","Z0052",
  "Z0067","Z0066","Z0069","Z0043","Z0070",
]);
...
/** GET /api/pin — vrátí { pins: { "Z0039": true, "Z0037": false, ... } } */
...
export async function onRequestPost({ request, env }) {
  ...
  if (!KNOWN_EMPLOYEES.has(employeeId)) {
    return new Response("Unknown employeeId", { status: 400 });
  }
